dropdown = {
    ...
    create: function ( value_id, descr_id, fill_callback ) {
        ...
        if ( ! ddWindow ) {
            ...
            m3.e('body').appendChild ( ddWindow )
        }
        ...
        button_close.onclick = function() {
            m3.id ( value_id ).value = ''
            m3.id ( descr_id ).value = ''
    ...
    wait: function( ddWindow ) {
        ...
        // Lo reponemos
        pos = m3.xy ( ddWindow.descrctrl )

        ddWindow.style.left = pos[0] + 'px'
        ddWindow.style.top = ( pos[1] + ddWindow.descrctrl.clientHeight ) + 'px'

        // Le colocamos el iconito de espera.
        ddWindow.innerHTML = '<div style="text-align: center"><img src="assets/imgs/m3_ajax_loading.gif" /></div>'
    },
