...
/**
 * M3 implementation of a HTTP Response based on PSR-7
 */
class Response extends PsrResponse
{
    ...
    /**
     * Creates a M3\Http\Response with a error code
     */
    ...
    {
        if (is_null($message)) {
            $message = "<p>The page <tt>/".M3::$request->getRequestTarget()."</tt> doesn't exists.</p>";
        }
    ...
    public function send() {
        ...
        /*if (M3::$debug) {
            M3\Logger::info(M3::$request->getMethod());
        }*/
