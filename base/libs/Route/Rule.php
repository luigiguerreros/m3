...
class Rule
{
    ...
    /**
     * Adds a simple URL mapping rule
     */
    ...
    /**
     * Adds a simple application rule
     */
    ...
    /**
     * Adds arguments for the callable.
     */
    ...
    /**
     * Returns a flatten array from a collection of Routes
     */
    /*public static function flatten(array $rules) 
    {
        $flat = [];
        foreach ($rules as $r) {
            $rule = $r->asArray();
     ...
     */
    private function process_target(array $args = []) 
    {
    ...
    private function found($args, $extra = []) 
    {
        $data = [
            'status' => 'found',
            'target' => $this->process_target($args),
