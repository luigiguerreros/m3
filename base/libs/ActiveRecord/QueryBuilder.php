...
{
    /**
     * M3 Query terminator to field format map,
     */
                    ...
                    if (is_array($value)) {
                        ...
                        if (is_object($value)) {
                            if ($value instanceof Comparison) {
                                ...
                                throw new \RuntimeException("'$key' value object (".get_class($value) . ") must be an instance of M3\\ActiveRecord\\Comparison or implements interface M3\\Database\\ValueInterface, to be used here.");
                            }
                        } else {
