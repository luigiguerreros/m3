 ...
 */
abstract class Record extends Base implements M3\AsArrayInterface, \Iterator
{
    ...
    {
        if ($data instanceof M3\AsArrayInterface) {
            $data = $data->asArray();
        }
        ...
        foreach ($data as $field => $value) {
            ...
            if ($value instanceof M3\Database\ValueInterface) {
