...
class _ {
    ...
    static function exception_handler ($e) {
        ...
        M3\Console\ExceptionHandler::handler($e);
...
Console::write ( "Launching M3 shell for {:project " . bin::$project_name . "} project..." );

Console::readline_on();
_::$prompt = Console::parse("{white " . bin::$project_name . "}", true);
Console::readline_off();

//require 'm3/start.php';
